<?php
    ...
    //Change session to Tuttle-Dunnington
    $_SESSION['dorm_name'] = 'Tuttle-Dunnington';
    ...
    // reviews for Tuttle-Dunnington from the database
    $dorm_name = 'Tuttle-Dunnington'; // name of the dorm for which to fetch review, change on each site
...
<head>
    ...
    <title>Tuttle-Dunnington Reviews</title>
