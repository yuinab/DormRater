<?php
    ...
    //Change session to Brown
    $_SESSION['dorm_name'] = 'Brown';
    ...
    // reviews for Brown from the database
    $dorm_name = 'Brown'; // name of the dorm for which to fetch review, change on each site
