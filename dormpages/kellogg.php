<?php
    ...
    //Change session to Kellogg
    $_SESSION['dorm_name'] = 'Kellogg';
    ...
    // reviews for Kellogg from the database
    $dorm_name = 'Kellogg'; // name of the dorm for which to fetch review, change on each site
