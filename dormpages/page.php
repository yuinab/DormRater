<?php
    ...
    //Change session to Page
    $_SESSION['dorm_name'] = 'Page';
    ...
    // reviews for Page from the database
    $dorm_name = 'Page'; // name of the dorm for which to fetch review, change on each site
