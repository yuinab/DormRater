<?php
    ...
    //Change session to Dabney
    $_SESSION['dorm_name'] = 'Dabney';
    ...
    // reviews for Dabney from the database
    $dorm_name = 'Dabney'; // name of the dorm for which to fetch review, change on each site
