<?php
    ...
    //Change session to Lefevre
    $_SESSION['dorm_name'] = 'Lefevre';
    ...
    // reviews for Lefevre from the database
    $dorm_name = 'Lefevre'; // name of the dorm for which to fetch review, change on each site
