<?php
    ...
    //Change session to Emmet
    $_SESSION['dorm_name'] = 'Emmet';
    ...
    // reviews for Emmet from the database
    $dorm_name = 'Emmet'; // name of the dorm for which to fetch review, change on each site
