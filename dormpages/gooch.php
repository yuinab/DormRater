<?php
    ...
    //Change session to Gooch
    $_SESSION['dorm_name'] = 'Gooch';
    ...
    // reviews for Gooch from the database
    $dorm_name = 'Gooch'; // name of the dorm for which to fetch review, change on each site
