<?php
    ...
    //Change session to Courtenay
    $_SESSION['dorm_name'] = 'Courtenay';
    ...
    // reviews for Courtenay from the database
    $dorm_name = 'Courtenay'; // name of the dorm for which to fetch review, change on each site
