<?php
    ...
    //Change session to Watson-Webb
    $_SESSION['dorm_name'] = 'Watson-Webb';
    ...
    // reviews for Watson-Webb from the database
    $dorm_name = 'Watson-Webb'; // name of the dorm for which to fetch review, change on each site
...
<head>
    ...
    <title>Watson-Webb Reviews</title>
