<?php
    ...
    //Change session to Humphreys
    $_SESSION['dorm_name'] = 'Humphreys';
    ...
    // reviews for Humphreys from the database
    $dorm_name = 'Humphreys'; // name of the dorm for which to fetch review, change on each site
