<?php
    ...
    //Change session to Hereford
    $_SESSION['dorm_name'] = 'Hereford';
    ...
    // reviews for Hereford from the database
    $dorm_name = 'Hereford'; // name of the dorm for which to fetch review, change on each site
