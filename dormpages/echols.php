<?php
    ...
    //Change session to Echols
    $_SESSION['dorm_name'] = 'Echols';
    ...
    // reviews for Echols from the database
    $dorm_name = 'Echols'; // name of the dorm for which to fetch review, change on each site
