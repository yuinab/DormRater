<?php
    ...
    //Change session to Dillard
    $_SESSION['dorm_name'] = 'Dillard';
    ...
    // reviews for Dillard from the database
    $dorm_name = 'Dillard'; // name of the dorm for which to fetch review, change on each site
