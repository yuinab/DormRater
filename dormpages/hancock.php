<?php
    ...
    //Change session to Hancock
    $_SESSION['dorm_name'] = 'Hancock';
    ...
    // reviews for Hancock from the database
    $dorm_name = 'Hancock'; // name of the dorm for which to fetch review, change on each site
