<?php
    ...
    //Change session to Kent
    $_SESSION['dorm_name'] = 'Kent';
    ...
    // reviews for Kent from the database
    $dorm_name = 'Kent'; // name of the dorm for which to fetch review, change on each site
