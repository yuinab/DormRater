<?php
    ...
    //Change session to International
    $_SESSION['dorm_name'] = 'International';
    ...
    // reviews for International from the database
    $dorm_name = 'International'; // name of the dorm for which to fetch review, change on each site
...
<head>
    ...
    <title>International Reviews</title>
