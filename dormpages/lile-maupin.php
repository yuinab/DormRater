<?php
    ...
    //Change session to Lile-Maupin
    $_SESSION['dorm_name'] = 'Lile-Maupin';
    ...
    // reviews for Lile-Maupin from the database
    $dorm_name = 'Lile-Maupin'; // name of the dorm for which to fetch review, change on each site
...
<head>
    ...
    <title>Lile-Maupin Reviews</title>
