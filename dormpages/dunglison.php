<?php
    ...
    //Change session to Dunglison
    $_SESSION['dorm_name'] = 'Dunglison';
    ...
    // reviews for Dunglison from the database
    $dorm_name = 'Dunglison'; // name of the dorm for which to fetch review, change on each site
