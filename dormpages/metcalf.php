<?php
    ...
    //Change session to Metcalf
    $_SESSION['dorm_name'] = 'Metcalf';
    ...
    // reviews for Metcalf from the database
    $dorm_name = 'Metcalf'; // name of the dorm for which to fetch review, change on each site
