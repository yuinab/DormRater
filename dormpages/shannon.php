<?php
    ...
    //Change session to Shannon
    $_SESSION['dorm_name'] = 'Shannon';
    ...
    // reviews for Shannon from the database
    $dorm_name = 'Shannon'; // name of the dorm for which to fetch review, change on each site
